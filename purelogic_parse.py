...
def collect_purelogic():
    ...
    for categ_link in categ_links[:-2]:
        ...
        if len(soup.find_all('a', class_='pagination-list__link')) > 1:
        ...
        for page in range(1, (int(pages_no)+1)):
            ...
            for card in item_cards:
                ...
                res_dict_link[name] = [price.strip().strip(' руб.с НДС'), link]
    ...
    with open(f'Datas/new/Data_purelogic/purelogic_{date_today}.json', 'w') as file:
